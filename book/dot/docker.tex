...
\begin{scope}
  ...
  \draw (232.5bp,180.0bp) -- (229.5bp,184.0bp) -- (208.5bp,184.0bp) -- (205.5bp,180.0bp) -- (52.5bp,180.0bp) -- (52.5bp,144.0bp) -- (232.5bp,144.0bp) -- cycle;
  \draw (142.5bp,162.0bp) node {rapid\_secdev\_framework};
\end{scope}
  % Node: docker
\begin{scope}
  \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
