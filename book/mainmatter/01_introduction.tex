...
Infrastructure as Code (IaC)\index{Infrastructure as Code (IaC)} is the platform
...
takes place, perhaps leaving only a few main providers of these cloud resources.
This has been likened to how power generation and distribution became centralized
...
Experience tells us that tools and process that are too cumbersome or burdensome
are typically circumvented, or even abandoned. Complexity in our processes become
the snags and side projects that are the enemy of productivity. 
