...
\begin{tcolorbox}[title=Example Dockerfile,height=6.0cm]
...
\begin{tcolorbox}[title=Example Dockerfile,height=6.5cm]
version: '3'\\
services:\\
...
\justify
\begin{tcolorbox}[title=Create files for Docker,height=3.5cm]
...
\begin{tcolorbox}[title=Build from docker-compose.yml file,height=3.5cm]
...
\begin{tcolorbox}[title=Change to bypass error,height=6.0cm]
