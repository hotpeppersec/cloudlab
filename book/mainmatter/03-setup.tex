...
\justify{}
A container has been created that defines a lab environment you can use to try out the commands shown in this
chapter. Directions for building and running the container are available in 
