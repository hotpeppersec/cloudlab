...
\subsection{Linux GPG Key Setup}

\begin{mybox}{\thetcbcounter: Linux GPG Key Setup}
...
\subsection{Macintosh GPG Key Setup}

\begin{mybox}{\thetcbcounter: SSH Key Generation}
\lstinputlisting{code/03_setup/gpg-key-setup-mac}
\end{mybox}
