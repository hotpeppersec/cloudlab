...
\markdownInput{../code/ch5/lab-5a.md}
...
\markdownInput{../code/ch5/lab-5b.md}
...
\markdownInput{../code/ch5/lab-5c.md}
...
\markdownInput{../code/ch5/lab-5d.md}
...
\begin{mybox}{\thetcbcounter: Adding a user to CODEOWNERS file}
      \lstinputlisting{code/05-github/create-codeowners.txt}
\end{mybox}
...
\begin{mybox}{\thetcbcounter: Example .gitignore file}
      \lstinputlisting{code/05-github/create-gitignore.txt}
\end{mybox}
