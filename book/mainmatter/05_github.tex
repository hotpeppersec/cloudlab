...
that is) is to configure two-factor authentication (2FA)\index{2FA} for your
GitHub account.
\justify{}
...
\begin{mybox}{\thetcbcounter: Output from make docker command}
  \lstinputlisting{code/05_github/make-docker-output.txt}
\end{mybox}
...
\begin{mybox}{\thetcbcounter: Adding a user to CODEOWNERS file}
      \lstinputlisting{code/05_github/create-codeowners.txt}
\end{mybox}
\justify{}
...
\begin{mybox}{\thetcbcounter: Example .gitignore file}
      \lstinputlisting{code/05_github/create-gitignore.txt}
\end{mybox}
