...
be combined with our customizations that describe and point to our application code,
all of which make up a single container that provides the functions of a fully provisioned server. We get the added
...
\justify{}
Once you have Docker installed and running on your workstation, take a look at the two example files below. It's OK for now
to see them and get a general familiarity with their contents. Later we will use these files
...
\begin{mybox}{\thetcbcounter: Dockerfile}
  \lstinputlisting{code/containers/Dockerfile}
\end{mybox}
...
\begin{mybox}{\thetcbcounter: Example docker-compose.yml}
  \lstinputlisting{code/containers/docker-compose.yml}
\end{mybox}
...
\section{Exercise: Testing Out Docker}
...
\begin{mybox}{\thetcbcounter: Create files for Docker,height=3.5cm}
  \lstinputlisting{code/containers/create-files.txt}
\end{mybox}
