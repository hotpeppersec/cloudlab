...
teams can collaborate on a single code base. Websites, like \href{https://github.com}{github.com} for example, are foundational
to our workflow. They are a key piece of our software delivery pipeline since they allow us to declare a single source of truth
for the code that makes up our project.
...
is a website that gives you a place to store the work you are using git to manage. 
